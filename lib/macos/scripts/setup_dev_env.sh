...
try_use_arm_brew install --cask 'ferdium'
...
try_use_arm_brew install --cask 'iina'
try_use_arm_brew install --cask 'jordanbaird-ice'
try_use_arm_brew install --cask 'quitter'
try_use_arm_brew install --cask 'responsively'
try_use_arm_brew install --cask 'superlist'
try_use_arm_brew install --cask 'utm'
try_use_arm_brew install --cask 'zed'
